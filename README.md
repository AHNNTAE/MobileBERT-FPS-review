...
| 게임 | 리뷰 수 | 추천율 |
|---|---|---|
| PLAYERUNKNOWN'S BATTLEGROUNDS | 144,846건 | 59.9% |
| Rust | 70,907건 | 78.5% |
| **합계** | **215,753건** | **- ** |

- **결측치**: `review` 텍스트가 비어있는 케이스 약 1,516건 제거 후 분석 진행
- **연도별 분포**: 2017년~2018년 사이에 리뷰가 집중되어 있으며, PUBG의 경우 2018년 이후 추천율이 급격히 하락하는 추세를 보임
- **플레이타임 분포**: 플레이타임이 길수록 추천율이 상승하는 경향이 있으며, 특히 Rust는 500시간 이상 유저의 추천율이 88.3%에 달함
